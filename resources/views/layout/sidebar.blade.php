<aside id="sidebar" class="text-[13px] w-64 bg-gradient-to-b from-[#0D1B5C] to-[#1a237e] text-white min-h-screen p-4 shadow-2xl
    ...
    <!-- Logo & Brand Area -->
        <div class="flex justify-between items-center mb-6 pb-4 border-b border-white/10">
            <div class="flex items-center gap-3">
                <div
                    class="w-10 h-10 rounded-xl bg-white flex items-center justify-center shadow-lg overflow-hidden">
    ...
    <nav class="flex-1 space-y-1">
            ...
            <div class="mb-4">
                ...
                <div x-data="{ openUser: {{ $isUserActive ? 'true' : 'false' }} }" class="mt-2">
                    ...
                    <div x-show="openUser" x-transition class="mt-2 ml-11 space-y-1">
                        ...
                        @foreach ($userMenus as $menu)
                            <a href="{{ $menu[1] }}" class="group flex items-center gap-2 px-3 py-2 rounded-lg transition-all duration-200
                ...
                <div x-data="{ openHelp: {{ $isHelpActive ? 'true' : 'false' }} }" class="mt-2">
                    ...
                    <div x-show="openHelp" x-transition class="mt-2 ml-11 space-y-1">
                        <a href="/buku-panduan" class="group flex items-center gap-2 px-3 py-2 rounded-lg transition-all duration-200
                                           hover:bg-white/5 hover:translate-x-1
                                           {{ request()->is('buku-panduan*') ? 'text-blue-300' : '' }}">
                            <i data-lucide="book-open" class="w-3.5 h-3.5"></i>
                            <span class="text-sm">Buku Panduan</span>
                        </a>
                        <a href="/hubungi-cs" class="group flex items-center gap-2 px-3 py-2 rounded-lg transition-all duration-200
                                           hover:bg-white/5 hover:translate-x-1
        ...
        @elseif($role === 'asesi')
            ...
            <!-- BANTUAN -->
            <div class="mb-4">
                <p class="text-[11px] uppercase tracking-wider text-white/40 font-semibold px-3 mb-3">Bantuan & Support</p>
        ...
        @elseif($role === 'asesor')
            ...
            <!-- ASESI -->
            <div class="mb-4">
                <p class="text-[11px] uppercase tracking-wider text-white/40 font-semibold px-3 mb-3">Manajemen Asesi</p>
                <div class="space-y-1">
                    @php
                        $asesorAsesiMenus = [
            ...
            <!-- ASESMEN -->
            <div class="mb-4">
                <p class="text-[11px] uppercase tracking-wider text-white/40 font-semibold px-3 mb-3">Aktivitas Asesmen</p>
                <div class="space-y-1">
                    @php
                        $asesmenMenus = [
            ...
            <div class="mb-4">
                ...
                <div x-data="{ open: {{ $isBantuanActive ? 'true' : 'false' }} }">
                    ...
                    <div x-show="open" x-transition class="mt-2 ml-11 space-y-1">
                        <a href="/asesor/bantuan/buku-panduan" class="group flex items-center gap-2 px-3 py-2 rounded-lg transition-all duration-200
                                           hover:bg-white/5 hover:translate-x-1
                                           {{ request()->is('asesor/bantuan/buku-panduan*') ? 'text-yellow-300' : '' }}">
                            <i data-lucide="book-open" class="w-3.5 h-3.5"></i>
                            <span class="text-sm">Buku Panduan</span>
                        </a>
                        <a href="/asesor/bantuan/hubungi-cs" class="group flex items-center gap-2 px-3 py-2 rounded-lg transition-all duration-200
                                           hover:bg-white/5 hover:translate-x-1
